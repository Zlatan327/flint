...
import { ArrowDownLeft, ArrowUpRight, ChevronUp, FileText, Shield, Zap } from "lucide-react";
...
export default function GigExchangePage() {
  useEffect(() => { document.title = "Gig Exchange | FLINT"; }, []);
  return (
    <div className="flint-app category-page category-page-exchange">
      ...
      <footer className="site-footer"><div className="footer-brand"><span className="brand-mark brand-mark-small" aria-hidden="true"><span className="brand-mark-cut" /></span><span className="brand-name">FLINT</span><span className="mono">EXCHANGE / V1</span></div><div className="footer-links"><Link href="/markets"><Shield size={13} /> PREDICTION MARKET</Link><a href="#gigs"><Zap size={13} /> OPEN GIGS</a><a href="#top"><FileText size={13} /> WORKER RULESET</a></div><a className="back-top mono" href="#top">BACK TO TOP <ChevronUp size={13} /></a></footer>
    </div>
  );
}
